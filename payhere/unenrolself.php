...
/**
 * PayHere enrolment plugin - support for user self unenrolment.
 *
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'payhere'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/payhere/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_payhere', format_string($course->fullname));
